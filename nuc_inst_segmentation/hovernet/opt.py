        ...
        "phase_list": [
            {
                "run_info": {
                    ...
                    "net": {
                        ...
                        #"pretrained": "ImageNet-ResNet50-Preact_pytorch.tar",
                        # 'pretrained': None,
                        "pretrained": "self_best.tar"
                    },
                },
                "target_info": {"gen": (gen_targets, {}), "viz": (prep_sample, {})},
                "batch_size": {"train": 32, "valid": 16,},  # engine name : value
                "nr_epochs": 50,
            },
            {
                "run_info": {
                ...
                "target_info": {"gen": (gen_targets, {}), "viz": (prep_sample, {})},
                "batch_size": {"train": 4, "valid": 16,}, # batch size per gpu
                "nr_epochs": 50,
            },
        ],
        # ------------------------------------------------------------------
